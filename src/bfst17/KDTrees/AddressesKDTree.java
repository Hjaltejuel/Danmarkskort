 ...
 */
public class AddressesKDTree extends KDTree {
    boolean isVertical = true;
    WayType type;
    TreeNode root;

    public AddressesKDTree(WayType type) {
        Size = 0;
        this.root = null;
        this.type = type;
    }
    ...
    public void fillTreeWithPoints(java.util.List<Point2D> points) {

    }

    public void fillTreeWithShapes(java.util.List<Shape> shapes) {
        if (shapes.size() == 0) {
            return;
        }
